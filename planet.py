...
def PlanetInfo():
    ...
    if planet == "Mercury":
        ...
        label_planet_info['text'] = "Mercury is the smallest planet in our solar sytem. It's just a little bigger than Earth's moon"
    elif planet == "Venus":
        label_planet_name['text'] = "Venus"
        label_planet_image['image'] = Venus
        label_planet_gravity_radius['text'] = "Gravity : 8.87 m/s2 \n Radius : 6,051.8 km"
        label_planet_info['text'] = "Venus is the brightest object in the sky after the Sun and the Moon, and sometimes lookes like a bright star in the morning or evening sky."
    elif planet == "Earth":
